...
export const SignUpModal = () => {
  return (
    <>
      <section className="absolute z-10 overflow-hidden mt-0 top-24">
        <div className="container">
          <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-5 px-6 dark:bg-dark sm:p-[60px]">
            ...
            <div className="items-center justify-center flex">
              <Button label="sign-in" size="medium" icon="google" />
            </div>
          </div>
        </div>
      </section>
      {/* 
      <section className="absolute z-10 overflow-hidden pt-0 pb-0 md:pb-0 lg:pt-[180px] lg:pb-28">
        <div className="container">
